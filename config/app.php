...
return [
    ...
    |--------------------------------------------------------------------------
    | Since RO users are processed by MD Bank, which accepts
    | only MDL currency, RO users gets charged in MDL also
    | This is a conversion rate RON -> MDL.
    |
    */
    ...
    */
    ...
    'url'             => env('APP_HOST', 'http://localhost:8000'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'providers'       => [
        ...
        App\Nutrition\NutritionSchedulerServiceProvider::class,
        Cviebrock\EloquentSluggable\SluggableServiceProvider::class,
        App\Providers\VbServiceProvider::class
    ],
    /*
    |--------------------------------------------------------------------------
    | Class Aliases
    ...
    */
    ...
    'yandex_metrica' => env('YANDEX_METRICA', null)
];
